    ...
    <div class="sidebar-content">
        <ul class="nav nav-secondary">
            ...
            @role(['Admin', 'Super Admin', 'Pimpinan'])
                ...
                @if (Auth::user()->can('View Partai') ||
                        Auth::user()->can('View Election') ||
                        Auth::user()->can('View Candidate') ||
                        Auth::user()->can('View TPS') ||
                        Auth::user()->can('View Vote'))
                    @role(['Admin', 'Super Admin', 'Pimpinan'])
                        <li class="nav-section">
                            <span class="sidebar-mini-icon">
                                <i class="fa fa-ellipsis-h"></i>
                            </span>
                            <h4 class="text-section" style="color: black;font-weight:bold">Master Data Existing</h4>
                        </li>
                    @endrole
                ...
                @if (Auth::user()->can('View TPS Realcount') ||
                    ...
                    @role(['Admin', 'Super Admin', 'Pimpinan'])
                        <li class="nav-section">
                            ...
                            <h4 class="text-section" style="color: black;font-weight:bold">Master Data Realcount</h4>
                        </li>
                    @endrole
                    @can('View TPS Realcount')
                        <li class="nav-item {{ Request::is('realcount-tps*') ? 'active' : '' }}">
                            <a href="{{ route('realcount-tps.index') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24"
                                    width="24" height="24">
                                    <path
                                        d="M23.576,6.429l-1.91-3.171L12,.036,2.334,3.258,.442,6.397c-.475,.792-.563,1.742-.243,2.607,.31,.839,.964,1.488,1.8,1.793l-.008,9.844,10,3.333,10-3.333,.008-9.844c.846-.296,1.507-.946,1.819-1.788,.317-.857,.229-1.797-.242-2.582Zm-5.737-2.338l-5.831,1.946-5.833-1.951,5.825-1.942,5.839,1.946ZM2.156,7.428l1.292-2.145,7.048,2.357-1.529,2.549c-.239,.398-.735,.581-1.173,.434l-5.081-1.693c-.297-.099-.53-.324-.639-.618-.108-.293-.079-.616,.082-.883Zm1.843,4.038l3.163,1.054c1.343,.448,2.792-.088,3.521-1.302l.316-.526-.005,10.843-7-2.333,.006-7.735Zm8.994,10.068l.005-10.849,.319,.532c.556,.928,1.532,1.459,2.561,1.459,.319,0,.643-.051,.96-.157l3.161-1.053-.006,7.734-7,2.333Zm8.95-13.216c-.105,.285-.331,.503-.619,.599l-5.118,1.706c-.438,.147-.934-.035-1.173-.434l-1.526-2.543,7.051-2.353,1.305,2.167c.156,.26,.186,.573,.08,.858Z" />
                    ...
                    @can('View Vote Realcount')
                        <li class="nav-item {{ Request::is('realcount-vote*') ? 'active' : '' }}">
                            <a href="{{ route('realcount-vote.index') }}">
                                ...
                                <p style="margin-left:16px">Suara Realcount</p>
                            </a>
                        </li>
                    @endcan
                    ...
                    @can('View Register Data D1')
                        <li class="nav-item {{ Request::is('file-d1*') ? 'active' : '' }}">
                            <a href="{{ route('file-d1.index') }}">
                                ...
                                <p style="margin-left:16px">Daftar Data D1</p>
                            </a>
                        </li>
                    @endcan
                    <li class="nav-item {{ Request::is('realcount*') ? 'active' : '' }}">
                        <a href="{{ route('realcount') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                viewBox="0 0 24 24" width="24" height="24">
                                <path
                                    d="M23.576,6.429l-1.91-3.171L12,.036,2.334,3.258,.442,6.397c-.475,.792-.563,1.742-.243,2.607,.31,.839,.964,1.488,1.8,1.793l-.008,9.844,10,3.333,10-3.333,.008-9.844c.846-.296,1.507-.946,1.819-1.788,.317-.857,.229-1.797-.242-2.582Zm-5.737-2.338l-5.831,1.946-5.833-1.951,5.825-1.942,5.839,1.946ZM2.156,7.428l1.292-2.145,7.048,2.357-1.529,2.549c-.239,.398-.735,.581-1.173,.434l-5.081-1.693c-.297-.099-.53-.324-.639-.618-.108-.293-.079-.616,.082-.883Zm1.843,4.038l3.163,1.054c1.343,.448,2.792-.088,3.521-1.302l.316-.526-.005,10.843-7-2.333,.006-7.735Zm8.994,10.068l.005-10.849,.319,.532c.556,.928,1.532,1.459,2.561,1.459,.319,0,.643-.051,.96-.157l3.161-1.053-.006,7.734-7,2.333Zm8.95-13.216c-.105,.285-.331,.503-.619,.599l-5.118,1.706c-.438,.147-.934-.035-1.173-.434l-1.526-2.543,7.051-2.353,1.305,2.167c.156,.26,.186,.573,.08,.858Z" />
                            </svg>
                            <p style="margin-left:16px">Realcount</p>
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::user()->can('View User Management') ||
                    ...
                    @role(['Admin', 'Super Admin', 'Pimpinan'])
                        <li class="nav-section">
                            ...
                            <h4 class="text-section" style="color: black;font-weight:bold">Master Data Informasi</h4>
                        </li>
                    @endrole
            ...
            @role('Koordinator Kelurahan|Koordinator Kecamatan|Koordinator RW')
                <li class="nav-section">
                    <span class="sidebar-mini-icon">
                        <i class="fa fa-ellipsis-h"></i>
                    </span>
