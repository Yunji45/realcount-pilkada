...
{
    // Ambil parameter filter dari request (kabupaten, kecamatan, kelurahan, rw, jenis pemilu)
    ...
    // Tambahkan filter berdasarkan kabupaten, kecamatan, kelurahan, rw, dan jenis pemilu
    if ($kabupatenId) {
